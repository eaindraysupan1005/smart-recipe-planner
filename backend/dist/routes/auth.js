...
authRouter.post('/signup', (req, res) => {
    ...
    if (!password)
        throw new HttpError(400, 'invalid_password', 'Enter a password.');
    if (!acceptTerms)
        throw new HttpError(400, 'terms_required', 'Please accept the Terms and the AI & Food Safety Disclaimer.');
...
authRouter.post('/login', (req, res) => {
    ...
    if (!user)
        throw new HttpError(404, 'no_account', 'No account with that email — create one instead.');
